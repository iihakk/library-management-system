      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">University Library</span>
            <span className="block text-primary-600">Management System</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Manage your library resources efficiently. Search catalogs, borrow books, and track your
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="p-6">
                ...
                <div className="mt-4">
                  <p className="text-base text-gray-500">
                    Search through thousands of books, journals, and resources with fuzzy matching and
                    advanced filters.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-6">
                ...
                <div className="mt-4">
                  <p className="text-base text-gray-500">
                    Borrow items with a single click. Track due dates, renewals, and manage your active
                    loans.
                  </p>
                </div>
              </div>
      ...
      <footer className="bg-white mt-20">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <p className="text-center text-base text-gray-400">
            &copy; 2025 University Library Management System
          </p>
        </div>
      </footer>
    </div>
